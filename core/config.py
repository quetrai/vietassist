...
class Settings:
    ...
    # KNOWLEDGE_BASE_DIR vì đây là 1 tài liệu cần nạp NGUYÊN VẸN vào system prompt của
    # /dich (không qua RAG top-k), tách riêng để không bị knowledge.reindex() nuốt vào
    # index chat RAG chung.
    translation_reference_path: str = os.getenv(
        "TRANSLATION_REFERENCE_PATH", "reference/nhat_viet_translation.md"
    ).strip()
